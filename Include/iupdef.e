--IUP callbacks, attributes and attribute values
...
public constant IUP_ALL = "ALL",
				...
				IUP_NON_SCROLLABLE_LINES = "NONE_SCROLLABLE_LINES",
				IUP_NONE_SCROLLABLE_COLS = "NONE_SCROLLABLE_COLS",
				IUP_ORIGIN = "ORIGIN",
...
public constant IUP_ENTERITEM_CB = "ENTERITEM_CB",
				...
				IUP_NUMCOL_VISIBLE = "NUMLIN_VISIBLE",
				IUP_MARKED = "MARKED",
...
public constant IUP_ADDLEAF = "ADDLEAF",
				...
				IUP_DELNODE = "DELNODE",
				IUP_IMAGELEAFE = "IMAGELEAF",
				IUP_IMAGEBRANCHCOLLAPSED = "IMAGECOLLAPSED",
