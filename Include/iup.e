...
public constant IUP_COPYRIGHT = "Copyright (C) 1994-2023 Tecgraf/PUC-Rio"
public constant IUP_VERSION = "3.331"
public constant IUP_VERSION_NUMBER = 331000
public constant IUP_VERSION_DATE = "2023/10/13"
...
public function IupOpen(atom argc,object argv)
...
public constant xIupMainLoop = define_c_func(iup,"+IupMainLoop",{},C_INT),
				xIupLoopStep = define_c_func(iup,"+IupLopStep",{},C_INT),
...
public procedure IupPostMessage(atom ih,sequence s,atom i,atom d,atom p)
...
public constant xIupExecute = define_c_func(iup,"+IupExecute",{C_STRING,C_STRING},C_INT),
				...
				xIupLog = define_c_proc(iup,"+IupLog",{C_STRING,C_STRING,C_INT})
				
public function IupExecute(sequence fname,sequence parms)
	return c_func(xIupExecute,{fname,parms})
end function

public function IupExecuteWait(sequence fname,sequence parms)
	return c_func(xIupExecuteWait,{fname,parms})
end function
...
public procedure IupLog(sequence stype,sequence format,atom x)
	c_proc(xIupLog,{stype,format,x})
end procedure
...
public constant xIupVersion = define_c_func(iup,"+IupVersion",{},C_STRING),
				xIupVersionDate = define_c_func(iup,"+IupVersionDate",{},C_STRING),
...
public constant xIupSetLanguage = define_c_proc(iup,"+IupSetLanguage",{C_STRING}),
				xIupGetLanguage = define_c_func(iup,"+IupGetLanguage",{},C_STRING),
				...
				xIupGetLanguageString = define_c_func(iup,"+IupGetLanguageString",{C_STRING},C_STRING),
...
public constant xIupResetAttribute = define_c_proc(iup,"+IupResetAttribute",{C_POINTER,C_STRING}),
				xIupGetAllAttributes = define_c_func(iup,"+IupGetAllAttributes",{C_POINTER,C_STRING,C_INT},C_INT),
				xIupCopyAttributes = define_c_proc(iup,"+IupCopyAttributes",{C_POINTER,C_POINTER}),
				xIupSetAtt = define_c_func(iup,"+IupSetAtt",{C_STRING,C_POINTER,C_STRING,C_INT},C_POINTER),
				xIupSetAttributes = define_c_func(iup,"+IupSetAttributes",{C_POINTER,C_STRING},C_POINTER),
				xIupGetAttributes = define_c_func(iup,"+IupGetAttributes",{C_POINTER},C_STRING)
...
public procedure IupCopyAttributes(atom src,atom dst)
	c_proc(xIupCopyAttributes,{src,dst})
end procedure

public function IupSetAtt(sequence handle_name,atom ih,sequence name,atom x)
	return c_func(xIupSetAtt,{handle_name,ih,name,x})
end function
...
public constant xIupSetAttribute = define_c_proc(iup,"+IupSetAttribute",{C_POINTER,C_STRING,C_STRING}),
				...
				xIupSetStrf = define_c_proc(iup,"+IupSetStrf",{C_POINTER,C_STRING,C_STRING,C_INT}),
...
public procedure IupSetStrf(atom ih,sequence name,sequence format,atom x)
	c_proc(xIupSetStrf,{ih,name,format,x})
end procedure
...
public constant xIupGetAttribute = define_c_func(iup,"+IupGetAttribute",{C_POINTER,C_STRING},C_STRING),
...
public constant xIupSetAttributeId = define_c_proc(iup,"+IupSetAttributeId",{C_POINTER,C_STRING,C_INT,C_STRING}),
				...
				xIupSetStrfId = define_c_proc(iup,"+IupSetStrfId",{C_POINTER,C_STRING,C_INT,C_STRING,C_INT}),
...
public procedure IupSetStrfId(atom ih,sequence name,atom id,sequence format,atom x)
	c_proc(xIupSetStrfId,{ih,name,id,format,x})
end procedure
...
public constant xIupGetAttributeId = define_c_func(iup,"+IupGetAttributeId",{C_POINTER,C_STRING,C_INT},C_STRING),
...
public constant xIupSetAttributeId2 = define_c_proc(iup,"+IupSetAttributeId2",{C_POINTER,C_STRING,C_INT,C_INT,C_STRING}),
				...
				xIupSetStrfId2 = define_c_proc(iup,"+IupSetStrfId2",{C_POINTER,C_STRING,C_INT,C_INT,C_STRING,C_INT}),
...
public procedure IupSetStrfId2(atom ih,sequence name,atom lin,atom col,sequence format,atom x)
	c_proc(xIupSetStrfId2,{ih,name,lin,col,format,x})
end procedure
...
public constant xIupGetAttributeId2 = define_c_func(iup,"+IupGetAttributeId2",{C_POINTER,C_STRING,C_INT,C_INT},C_STRING),
...
public constant xIupSetGlobal = define_c_proc(iup,"+IupSetGlobal",{C_STRING,C_STRING}),
				...
				xIupGetGlobal = define_c_func(iup,"+IupGetGlobal",{C_STRING},C_STRING)
...
public constant xIupGetCallback = define_c_func(iup,"+IupGetCallback",{C_POINTER,C_STRING},C_POINTER),
				...
				xIupSetCallbacks = define_c_func(iup,"+IupSetCallbacks",{C_POINTER,C_STRING,C_POINTER,C_INT},C_POINTER)
				
public function IupGetCallback(atom ih,sequence name)
	return c_func(xIupGetCallback,{ih,name})
end function

public function IupSetCallback(atom ih,sequence name,atom func)
...
public constant xIupGetHandle = define_c_func(iup,"+IupGetHandle",{C_STRING},C_POINTER),
				...
				xIupGetAllNames = define_c_func(iup,"+IupGetAllNames",{C_STRING,C_INT},C_INT),
				xIupGetAllDialogs = define_c_func(iup,"+IupGetAllDialogs",{C_STRING,C_INT},C_INT),
				xIupGetName = define_c_func(iup,"+IupGetName",{C_POINTER},C_STRING)
...
public constant xIupGetClassName = define_c_func(iup,"+IupGetClassName",{C_POINTER},C_STRING),
				xIupGetClassType = define_c_func(iup,"+IupGetClassType",{C_POINTER},C_STRING),
				xIupGetAllClasses = define_c_func(iup,"+IupGetAllClasses",{C_STRING,C_INT},C_INT),
				xIupGetClassAttributes = define_c_func(iup,"+IupGetClassAttributes",{C_STRING,C_STRING,C_INT},C_INT),
				xIupGetClassCallbacks = define_c_func(iup,"+IupGetClassCallbacks",{C_STRING,C_STRING,C_INT},C_INT),
...
public function IupGetAllClasses(sequence name,atom n)
	return c_func(xIupGetAllClasses,{name,n})
end function

public function IupGetClassAttributes(sequence cname,sequence name,atom n)
	return c_func(xIupGetClassAttributes,{cname,name,n})
end function

public function IupGetClassCallbacks(sequence cname,sequence name,atom n)
	return c_func(xIupGetClassCallbacks,{cname,name,n})
end function

public function IupSaveClassAttributes(atom ih)
	return c_func(xIupSaveClassAttributes,{ih})
end function
...
public procedure IupSetClassDefaultAttribute(sequence cname,sequence name,sequence val)
	c_proc(xIupSetClassDefaultAttribute,{cname,name,val})
end procedure

public function IupClassMatch(atom ih,sequence cname)
	return c_func(xIupClassMatch,{ih,cname})
end function
...
public constant xIupCreate = define_c_func(iup,"+IupCreate",{C_STRING},C_POINTER),
				...
				xIupCreatep = define_c_func(iup,"+IupCreatep",{C_STRING,C_POINTER,C_INT},C_POINTER)
				
public function IupCreate(sequence name)
	return c_func(xIupCreate,{name})
end function

public function IupCreatev(sequence name,atom params)
	return c_func(xIupCreatev,{name,params})
end function

public function IupCreatep(sequence name,atom first,atom x)
	return c_func(xIupCreatep,{name,first,x})
end function
...
public constant xIupRadio = define_c_func(iup,"+IupRadio",{C_POINTER},C_POINTER),
				xIupVbox = define_c_func(iup,"+IupVbox",{C_POINTER,C_INT},C_POINTER),
				xIupVboxv = define_c_func(iup,"+IupVboxv",{C_POINTER},C_POINTER),
				xIupZbox = define_c_func(iup,"+IupZbox",{C_POINTER,C_INT},C_POINTER),
...
public function IupZbox(atom child,atom x)
	return c_func(xIupZbox,{child,x})
end function
...
public function IupHbox(atom child,atom x)
...
public constant xIupNormalizer = define_c_func(iup,"+IupNormalizer",{C_POINTER,C_INT},C_POINTER),
				xIupNormalizerv = define_c_func(iup,"+IupNormalizerv",{C_POINTER},C_POINTER)
				
public function IupNormalizer(atom ih_first,atom x)
	return c_func(xIupNormalizer,{ih_first,x})
end function

public function IupNormalizerv(atom ih_list)
	return c_func(xIupNormalizerv,{ih_list})
end function

public constant xIupCbox = define_c_func(iup,"+IupCbox",{C_POINTER,C_INT},C_POINTER),
				...
				xIupGridBox = define_c_func(iup,"+IupGridBox",{C_POINTER,C_INT},C_POINTER),
				xIupGridBoxv = define_c_func(iup,"+IupGridBoxv",{C_POINTER},C_POINTER),
				xIupMultiBox = define_c_func(iup,"+IupMultiBox",{C_POINTER,C_INT},C_POINTER),
...
public function IupCbox(atom child,atom x)
	return c_func(xIupCbox,{child,x})
end function
...
public function IupGridBox(atom child,atom x)
	return c_func(xIupGridBox,{child,x})
end function

public function IupGridBoxv(atom children)
	return c_func(xIupGridBoxv,{children})
end function

public function IupMultiBox(atom child,atom x)
	return c_func(xIupMultiBox,{child,x})
end function
...
public constant xIupItem = define_c_func(iup,"+IupItem",{C_STRING,C_STRING},C_POINTER),
				...
				xIupMenu = define_c_func(iup,"+IupMenu",{C_POINTER,C_POINTER},C_POINTER),
...
public function IupMenu(atom child,atom x)
	return c_func(xIupMenu,{child,x})
end function
...
public constant xIupButton = define_c_func(iup,"+IupButton",{C_STRING,C_STRING},C_POINTER),
				...
				xIupTabs = define_c_func(iup,"+IupTabs",{C_POINTER,C_POINTER},C_POINTER),
				xIupTabsv = define_c_func(iup,"+IupTabsv",{C_POINTER},C_POINTER),
				xIupFlatTabs = define_c_func(iup,"+IupFlatTabs",{C_POINTER,C_POINTER},C_POINTER),
...
public function IupTabs(atom child,atom x)
	return c_func(xIupTabs,{child,x})
end function
...
public function IupFlatTabs(atom child,atom x)
	return c_func(xIupFlatTabs,{child,x})
end function
...
public function IupStringCompare(sequence str,sequence str2,atom casesens,atom lexi)
	return c_func(xIupStringCompare,{str,str2,casesens,lexi})
end function
...
public constant xIupTextConvertLineColToPos = define_c_proc(iup,"+IupTextConvertLineColToPos",{C_POINTER,C_INT,C_INT,C_POINTER}),
				xIupTextConvertPosToLinCol = define_c_proc(iup,"+IupTextConvertPosToLinCol",{C_POINTER,C_INT,C_POINTER,C_POINTER})
				
public procedure IupTextConvertLineColToPos(atom ih,atom lin,atom col,atom pos)
	c_proc(xIupTextConvertLineColToPos,{ih,lin,col,pos})
end procedure
...
public constant xIupGetFile = define_c_func(iup,"+IupGetFile",{C_STRING},C_INT),
				xIupMessage = define_c_proc(iup,"+IupMessage",{C_STRING,C_STRING}),
				xIupMessagef = define_c_proc(iup,"+IupMessagef",{C_STRING,C_STRING,C_POINTER}),
				xIupMessageError = define_c_proc(iup,"+IupMessageError",{C_POINTER,C_STRING}),
				xIupMessageAlarm = define_c_func(iup,"+IupMessageAlarm",{C_STRING,C_STRING,C_STRING,C_STRING,C_STRING},C_INT),
				xIupAlarm = define_c_func(iup,"+IupAlarm",{C_STRING,C_STRING,C_STRING,C_STRING,C_STRING},C_INT),
				xIupScanf = define_c_func(iup,"+IupScanf",{C_STRING,C_POINTER},C_INT),
				xIupListDialog = define_c_func(iup,"+IupListDialog",{C_INT,C_STRING,C_INT,C_STRING,C_INT,C_INT,C_INT,C_POINTER},C_INT),
				xIupGetText = define_c_func(iup,"+IupGetText",{C_STRING,C_STRING,C_INT},C_INT),
...
public procedure IupMessagef(sequence title,sequence format,atom x)
	c_proc(xIupMessagef,{title,format,x})
end procedure
...
public function IupMessageAlarm(atom parent,sequence title,sequence msg,sequence btns)
	return c_func(xIupMessageAlarm,{parent,title,msg,btns})
end function
...
public function IupScanf(sequence format,atom x)
	return c_func(xIupScanf,{format,x})
end function

public function IupListDialog(atom xtype,sequence title,atom size,sequence list,atom op,atom max_col,atom max_lin,atom marks)
	return c_func(xIupListDialog,{xtype,title,size,list,op,max_col,max_lin,marks})
end function

public function IupGetText(sequence title,sequence text,atom maxsize)
	return c_func(xIupGetText,{title,text,maxsize})
end function
...
public constant xIupGetParam = define_c_func(iup,"+IupGetParam",{C_STRING,C_POINTER,C_POINTER,C_STRING,C_POINTER},C_INT),
				...
				xIupParamBox = define_c_func(iup,"+IupParamBox",{C_POINTER,C_POINTER},C_POINTER),
				xIupParamBoxv = define_c_func(iup,"+IupParamBoxv",{C_POINTER},C_POINTER)
				
public function IupGetParam(sequence title,atom action,atom user_data,sequence format,atom x)
	return c_func(xIupGetParam,{title,action,user_data,format,x})
end function

public function IupGetParamv(sequence title,atom action,atom user_data,sequence format,atom param_count,atom param_extra,atom param_data)
	return c_func(xIupGetParamv,{title,action,user_data,format,param_count,param_extra,param_data})
end function
...
public function IupParamBox(atom param,atom x)
	return c_func(xIupParamBox,{param,x})
end function

public function IupParamBoxv(atom param_array)
	return c_func(xIupParamBoxv,{param_array})
end function
...
public function IupElementPropertiesDialog(atom parent,atom ele)
	return c_func(xIupElementPropertiesDialog,{parent,ele})
end function
...
public enum IUP_RECBINARY = 0,
			IUP_RECTEXT

--IUP Canvas Draw API

--All Drawing functions need to be called between Begin and End Draw Functions
public constant xIupDrawBegin = define_c_proc(iup,"+IupDrawBegin",{C_POINTER}),
				xIupDrawEnd = define_c_proc(iup,"+IupDrawEnd",{C_POINTER})
				
public procedure IupDrawBegin(atom ih)
	c_proc(xIupDrawBegin,{ih})
end procedure

public procedure IupDrawEnd(atom ih)
	c_proc(xIupDrawEnd,{ih})
end procedure

public constant xIupDrawSetClipRect = define_c_proc(iup,"+IupDrawSetClipRect",{C_POINTER,C_INT,C_INT,C_INT,C_INT}),
				xIupDrawGetClipRect = define_c_proc(iup,"+IupDrawGetClipRect",{C_POINTER,C_POINTER,C_POINTER,C_POINTER,C_POINTER}),
				xIupDrawResetClip = define_c_proc(iup,"+IupDrawResetClip",{C_POINTER})
				
public procedure IupDrawSetClipRect(atom ih,atom x,atom y,atom x2,atom y2)
	c_proc(xIupDrawSetClipRect,{ih,x,y,x2,y2})
end procedure

public procedure IupDrawGetClipRect(atom ih,atom x,atom y,atom x2,atom y2)
	c_proc(xIupDrawGetClipRect,{ih,x,y,x2,y2})
end procedure

public procedure IupDrawResetClip(atom ih)
	c_proc(xIupDrawResetClip,{ih})
end procedure

public constant xIupDrawParentBackground = define_c_proc(iup,"+IupDrawParentBackground",{C_POINTER}),
				xIupDrawLine = define_c_proc(iup,"+IupDrawLine",{C_POINTER,C_INT,C_INT,C_INT,C_INT}),
				xIupDrawRectangle = define_c_proc(iup,"+IupDrawRectangle",{C_POINTER,C_INT,C_INT,C_INT,C_INT}),
				xIupDrawArc = define_c_proc(iup,"+IupDrawArc",{C_POINTER,C_INT,C_INT,C_INT,C_INT,C_DOUBLE,C_DOUBLE}),
				xIupDrawPolygon = define_c_proc(iup,"+IupDrawPolygon",{C_POINTER,C_POINTER,C_INT}),
				xIupDrawText = define_c_proc(iup,"+IupDrawText",{C_POINTER,C_STRING,C_INT,C_INT,C_INT,C_INT,C_INT}),
				xIupDrawImage = define_c_proc(iup,"+IupDrawImage",{C_POINTER,C_STRING,C_INT,C_INT,C_INT,C_INT}),
				xIupDrawSelectRect = define_c_proc(iup,"+IupDrawSelectRect",{C_POINTER,C_INT,C_INT,C_INT,C_INT}),
				xIupDrawFocusRect = define_c_proc(iup,"+IupDrawFocusRect",{C_POINTER,C_INT,C_INT,C_INT,C_INT})
				
public procedure IupDrawParentBackground(atom ih)
	c_proc(xIupDrawParentBackground,{ih})
end procedure

public procedure IupDrawLine(atom ih,atom x,atom y,atom x2,atom y2)
	c_proc(xIupDrawLine,{ih,x,y,x2,y2})
end procedure

public procedure IupDrawRectangle(atom ih,atom x,atom y,atom x2,atom y2)
	c_proc(xIupDrawRectangle,{ih,x,y,x2,y2})
end procedure

public procedure IupDrawArc(atom ih,atom x,atom y,atom x2,atom y2,atom a,atom a2)
	c_proc(xIupDrawArc,{ih,x,y,x2,y2,a,a2})
end procedure

public procedure IupDrawPolygon(atom ih,atom points,atom count)
	c_proc(xIupDrawPolygon,{ih,points,count})
end procedure

public procedure IupDrawText(atom ih,sequence text,atom len,atom x,atom y,atom w,atom h)
	c_proc(xIupDrawText,{ih,text,len,x,y,w,h})
end procedure

public procedure IupDrawSelectRect(atom ih,atom x,atom y,atom x2,atom y2)
	c_proc(xIupDrawSelectRect,{ih,x,y,x2,y2})
end procedure

public procedure IupDrawFocusRect(atom ih,atom x,atom y,atom x2,atom y2)
	c_proc(xIupDrawFocusRect,{ih,x,y,x2,y2})
end procedure

public constant xIupDrawGetSize = define_c_proc(iup,"+IupDrawGetSize",{C_POINTER,C_POINTER,C_POINTER}),
				xIupDrawGetTextSize = define_c_proc(iup,"+IupDrawGetTextSize",{C_POINTER,C_STRING,C_INT,C_POINTER,C_POINTER}),
				xIupDrawGetImageInfo = define_c_proc(iup,"+IupDrawGetImageInfo",{C_STRING,C_POINTER,C_POINTER,C_POINTER})
				
public procedure IupDrawGetSize(atom ih,atom w,atom h)
	c_proc(xIupDrawGetSize,{ih,w,h})
end procedure

public procedure IupDrawGetTextSize(atom ih,sequence text,atom len,atom w,atom h)
	c_proc(xIupDrawGetTextSize,{ih,text,len,w,h})
end procedure

public procedure IupDrawGetImageInfo(sequence name,atom w,atom h,atom bpp)
	c_proc(xIupDrawGetImageInfo,{name,w,h,bpp})
end procedure
­35.40